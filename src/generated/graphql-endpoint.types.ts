...
export const RoleCode = {
  ...
  MiniEventCoordinator: 'MINI_EVENT_COORDINATOR',
  Moderator: 'MODERATOR',
  Musician: 'MUSICIAN',
  OutreachDirector: 'OUTREACH_DIRECTOR',
  PortfolioManager: 'PORTFOLIO_MANAGER',
  President: 'PRESIDENT',
  PreProfessionalManager: 'PRE_PROFESSIONAL_MANAGER',
  ...
  Secretary: 'SECRETARY',
  SocialmediaManager: 'SOCIALMEDIA_MANAGER',
...
export type UserResolvers<ContextType = any, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = {
  ...
  manualVerified?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
