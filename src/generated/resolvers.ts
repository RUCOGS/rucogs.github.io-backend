...
export const resolvers: { Mutation: types.MutationResolvers; Query: types.QueryResolvers } = {
  Query: {
    ...
    someTypes: (parent, args, context, info) => context.entityManager.someType.resolvers.read(args, info),
  ...
  Mutation: {
    ...
    createSomeType: async (parent, args, context, info) => context.entityManager.someType.resolvers.create(args, info),
    updateSomeTypes: async (parent, args, context) => context.entityManager.someType.resolvers.update(args),
    deleteSomeTypes: async (parent, args, context) => context.entityManager.someType.resolvers.delete(args),
