...
projectDiscordSettingss: (parent, args, context, info) => context.entityManager.projectDiscordSettings.resolvers.read(args, info),
...
createProjectDiscordSettings: async (parent, args, context, info) => context.entityManager.projectDiscordSettings.resolvers.create(args, info),
    updateProjectDiscordSettingss: async (parent, args, context) => context.entityManager.projectDiscordSettings.resolvers.update(args),
    deleteProjectDiscordSettingss: async (parent, args, context) => context.entityManager.projectDiscordSettings.resolvers.delete(args),
