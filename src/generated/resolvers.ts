...
projectDiscordConfigs: (parent, args, context, info) => context.entityManager.projectDiscordConfig.resolvers.read(args, info),
...
createProjectDiscordConfig: async (parent, args, context, info) => context.entityManager.projectDiscordConfig.resolvers.create(args, info),
    updateProjectDiscordConfigs: async (parent, args, context) => context.entityManager.projectDiscordConfig.resolvers.update(args),
    deleteProjectDiscordConfigs: async (parent, args, context) => context.entityManager.projectDiscordConfig.resolvers.delete(args),
